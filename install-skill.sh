#!/bin/sh
# Install the layered-assistant-rails agent skill globally for Claude Code.
#
...
DEST="$HOME/.claude/skills/layered-assistant-rails"
SKILL_PATH=".claude/skills/layered-assistant-rails"

echo "Installing layered-assistant-rails agent skill..."
...
if [ -f "$LOCAL_SKILL/SKILL.md" ]; then
  ...
  REPO="layered-ai-public/layered-assistant-rails"
...
echo "Installed layered-assistant-rails agent skill to $DEST"
